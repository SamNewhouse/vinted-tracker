...
export function calcBreakEvenPrice(allocatedPurchaseCost: number, allocatedExtraCostShare: number): number {
...
export function calcItemProfit(
  ...
  return salePrice - allocatedPurchaseCost - allocatedExtraCostShare - calcTotalSaleCosts(saleCosts)
}
