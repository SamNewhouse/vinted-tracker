...
## In progress
- Analytics page (charts and trend data)
...
- Mark item as listed (with listed price)
- Sale cost tracking on items (postage, fees)
- Bundle profit progress bar on bundle card
...
- Write unit tests for selectors and finance utils
